...
public class SandLayerBlock extends FallingBlock {
    ...
    public SandLayerBlock() {
        ...
        ((EditableMiningTool)Items.DIAMOND_SHOVEL).trikzon_addEffectiveBlock(this);
    }

    @Override
    public void onLanding(World world, BlockPos pos, BlockState fallingBlockState, BlockState currentStateInPos) {
        System.out.println(currentStateInPos.getBlock());
...
//        return state.isAir() || block == Blocks.FIRE || material.isLiquid() || material.isReplaceable() || block instanceof SandLayerBlock;
//    }
